...
- Shell helper **`pb install`** — installs known external tools by short name, including `ai`/`codex` for the Codex CLI installer and `tailscale` for the Tailscale installer.
